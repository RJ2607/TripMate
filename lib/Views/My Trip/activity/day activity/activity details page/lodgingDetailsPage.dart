                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        data['isCheckOut']
                            ? Text(
                                'Check Out: ${TimeOfDay(hour: DateTime.fromMillisecondsSinceEpoch(data['checkOutTime'].millisecondsSinceEpoch).hour, minute: DateTime.fromMillisecondsSinceEpoch(data['checkOutTime'].millisecondsSinceEpoch).minute).format(context)}',
                            ...
                            : Text(
                                'Check In: ${TimeOfDay(hour: DateTime.fromMillisecondsSinceEpoch(data['checkInTime'].millisecondsSinceEpoch).hour, minute: DateTime.fromMillisecondsSinceEpoch(data['checkInTime'].millisecondsSinceEpoch).minute).format(context)}',
                                style: Theme.of(context)
                                    .textTheme
                                    .titleMedium!
                                    .copyWith(color: Colors.grey),
